...
function App() {
  ...
  // prompt user to connect to MetaMask with popup
        ...
        {!isConnected ? (
          ...
          <div id='homepage' className='mt-0'>
            ...
            <div id='stars' className="absolute top-0 left-0 w-full h-full pointer-events-none">
              {[...Array(70)].map((_, i) => (
                <span
                  key={i} className="absolute w-[2px] h-[2px] bg-white rounded-full"
                  style={{
                    top: `${Math.random() * 100}%`,
